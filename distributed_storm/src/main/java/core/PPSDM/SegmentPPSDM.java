...
import ppsdm.core.PPSDM.charm.AlgoCharmBitsetWithSpeedRegulation;
import ppsdm.core.PPSDM.charm.Context;
import ppsdm.core.PPSDM.charm.Itemset;
import ppsdm.core.PPSDM.charm.Itemsets;
...
public class SegmentPPSDM implements Serializable{
     ...
     * @param instance
     */
    public void addItemset(Itemset instance){
        context.addItemset(instance);
    }
