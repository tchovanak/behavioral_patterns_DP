...
//            return UtilitiesPPSDM.similarityBetweenVectors(items, center)/getRadius();
	...
	public double getCenterDistance(Instance instance) {
        ...
        public double getCenterDistance(Instance instance, DistanceMetricsEnum metric) {
            double[] center = getCenter();
            double distance = UtilitiesPPSDM.distanceBetweenVectors(center, instance.toDoubleArray(), metric);
            return distance;
        }
        
        public double getDistanceToRadius(Instance instance) {
            double[] center = getCenter();
            double distance = UtilitiesPPSDM.distanceBetweenVectors(center, instance.toDoubleArray());
            double radius = getRadius();
            if(distance < radius){
