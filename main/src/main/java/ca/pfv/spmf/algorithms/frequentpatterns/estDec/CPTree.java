...
public class CPTree {
	...
	Hashtable<int[], Double> patterns = new Hashtable<int[], Double>();
	...
	int[] itemsetBuffer = new int[20000];

	/**
	 * Constructor
	 */
	public CPTree(double decay, double mins,  double minSigValue, double deltaValue, double minMergeValue) {
	 ...
	 ********************************************************************/
	public double getCountOfItemset(int[] itemset) {
	 ...
	 *            t
	 ********************************************************************/
	public void forcePruning(CPTreeNode currentNode) {
        ...
        /********************************************************************
	 * Recursive method for finding all itemsets.
	 * 
	 * @param root   root of the current subtree
	 * @param pattern    current pattern
	 * @throws IOException
	 ********************************************************************/
	public void itemsetsMining(CPTreeNode currentNode, int[] pattern) throws IOException {
	 ...
	 * @throws IOException
	 ********************************************************************/
	public void patternMining(CPTreeNode currentNode, int[] pattern) throws IOException {
		if (currentNode.itemIDList != null && currentNode.itemIDList.size() > 0) {
...
//		int l = m.itemIDList.size();
    ...
    public Hashtable<int[], Double> getPatterns() {
       return patterns;
    }
